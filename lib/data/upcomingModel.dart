...
//
//     final upcomingImages = upcomingImagesFromJson(jsonString);

import 'dart:convert';

UpcomingImages upcomingImagesFromJson(String str) => UpcomingImages.fromJson(json.decode(str));

String upcomingImagesToJson(UpcomingImages data) => json.encode(data.toJson());

class UpcomingImages {
  final Dates? dates;
  final int? page;
  ...
  factory UpcomingImages.fromJson(Map<String, dynamic> json) => UpcomingImages(
