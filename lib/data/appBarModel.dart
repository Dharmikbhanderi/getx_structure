...
//
//     final appbarList = appbarListFromJson(jsonString);

import 'dart:convert';

AppbarList appbarListFromJson(String str) => AppbarList.fromJson(json.decode(str));

String appbarListToJson(AppbarList data) => json.encode(data.toJson());
...
class AppbarList {
  ...
  factory AppbarList.fromJson(Map<String, dynamic> json) => AppbarList(
    status: json["Status"],
